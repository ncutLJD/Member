...
public class MD5SaltUtils {
	...
	public static String encode(LoginUserInfo loginUserInfo)
	{
		if (loginUserInfo!=null) {
			...
			try {
				MessageDigest md=MessageDigest.getInstance("MD5");
				result=encoder16(md.digest((addSalt(loginUserInfo.getPwd(),loginUserInfo.getSalt()).getBytes("UTF-8"))));
			} catch (Exception e) {
				// TODO: handle exception
			}
			return result;
	...
	static LoginUserInfo addUserSalt(String salt)
	{
